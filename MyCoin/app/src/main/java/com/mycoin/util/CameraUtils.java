...
public class CameraUtils {
    ...
    private static String authority = "com.mycoin";

    public static Uri getImageUri(Context context) {
        Uri imageUri;
        File outPutImage = new File(context.getExternalCacheDir(), System.currentTimeMillis() + "mycoin.jpg");
        ...
        try {
            ...
            ToastUtils.showShort(context, "存储相片失败");
        }
    ...
    public static void display(Context context, Uri imgUri, ImageView view) throws FileNotFoundException {
        Bitmap bitmap = BitmapFactory.decodeStream(context.getContentResolver().openInputStream(imgUri));
